#!/usr/bin/python3
'''This unittest module for the BaseModel Class.'''
...
class TestBaseModel(unittest.TestCase):
    ...
    '''This is the test Cases for the BaseModel class.'''

    def setUp(self):
        ''' This actaully sets up test methods.to prevent duplication'''
        pass
